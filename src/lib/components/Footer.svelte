  ...
  <div class="mx-auto max-w-7xl p-5">
    ...
    <div class="mt-8 grid grid-cols-1 gap-10 md:grid-cols-3">
      <div class="flex flex-col">
        <h2 class="mb-2 font-semibold text-white">CATALOGUE</h2>
        <a class="hover:text-white focus-visible:text-white" href="/products/Dupatta">Dupatta</a>
        <a class="hover:text-white focus-visible:text-white" href="/products/Saree">Saree</a>
        <a class="hover:text-white focus-visible:text-white" href="/products/Dress">Dress</a>
        <a class="hover:text-white focus-visible:text-white" href="/products/Top Material"
          >Top Material</a
        >
      </div>
      <div class="flex flex-col items-center text-center">
        <h2 class="mx-auto mb-2 font-semibold text-white">CONTACT US</h2>
        <a
          rel="noreferrer"
          target="_blank"
          class="mb-2 flex items-center gap-1 transition hover:text-white"
      ...
      <div class="text-end">
        <h2 class="mx-auto mb-2 font-semibold text-white">ADDRESS</h2>
        <div>
          <p>
            1079, ApnaNagar-1, <br /> Near Sejwala Matam, <br /> Bhuj-Kachchh, Gujarat
          </p>
        </div>
      </div>
    </div>
    <hr class="my-10 border-white/10" />
    <div class="mb-5 grid md:grid-cols-3 md:gap-10">
      <div class="col-span-2 mb-4 md:mb-0">
        <a class="transition hover:text-white" href="/terms-conditions"> Terms & Conditions </a>
